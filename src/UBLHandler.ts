...
const object = JSON.parse(testJsonString);
const ublString = json2xml(testJsonString, options)
//console.log(ublString);

const order: Order = JSON.parse(testJsonString);
//console.log(order.buyer.buyerAddress.stateName);
*/